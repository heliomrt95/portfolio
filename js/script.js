...
// Affiche le formulaire au clic sur "Me Contacter" (section projets)
const carouselContactBtn = document.getElementById('carousel-contact-btn');
if (carouselContactBtn) {
  carouselContactBtn.addEventListener('click', function (e) {
    e.preventDefault();
    showForm();
  });
}
